...
export default class Header extends React.Component {
  ...
  loggedInSegMenuClick(ev) {
    ...
    ev.target.parentElement.parentElement.firstElementChild.classList.remove(
      "clicked"
    );
  }
        ...
        <div className="headerContainer">
          ...
          {this.props.loggedIn ? (
            <div className="customerMenu">
              <a
                href=""
                className="customerMenuContainer"
                onClick={this.toggleCustomerSeg.bind(this)}
              >
              ...
              <ul className="customerSeg none">
                <li
                  className="profile"
                  onClick={this.loggedInSegMenuClick.bind(this)}
                >
                  Profile
                </li>
                <li
                ...
                <li
                  className="logout"
                  onClick={this.googleAuthLogout.bind(this)}
                >
                  Logout
                </li>
              </ul>
            ...
            <div className="registerContainer">
              <div className="logIn" onClick={this.loginModal.bind(this)}>
                Log In
              </div>
              <div
