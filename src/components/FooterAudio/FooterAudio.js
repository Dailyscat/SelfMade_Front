                ...
                <div className="audioContainer">
                    <div className="audioPlayer">
                            <div className="playerButtonContainer">
                                <button className ="button play" onClick = {this.togglePlay.bind(this)}>{this.state.is_playing ? <img src={Pause} alt=""/> : <img src={Play} alt=""/> }</button>
                            ...
                            <div className="songProfile">
                                <div className="thumbNail" style={{backgroundImage: `url(${currentSong ? currentSong.thumbNail : ""})`}}></div>
