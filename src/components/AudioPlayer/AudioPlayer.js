                        ...
                        <div className="listAudioContainer">
                            <div className="listAudioPlayer">
                                    <div className="listPlayerButtonContainer">
                                        <button className ="listPlayerPlay" onClick = {this.togglePlay.bind(this)}>{this.state.is_playing ? <img src={Pause} alt=""/> : <img src={Play} alt=""/> }</button>
                                    </div>
                                    <div className="listPlayerSeekBar" 
                                    ...
                                    >
                                        <div className="progress" ref={(ref) => this._progress_bar = ref}>
                                            <div className="progressBar" style = {{width: (this.state.progress * 100 ) + "%"}}>
                                            <span className="progressBall">
                                    ...
                                    <div className="listPlayerSongProfile">
                                        <div className="listPlayerThumbNail" style={{backgroundImage: `url(${this.props.songInfo.thumbNail})`}}></div>
                                        <div className="listPlayerArtistName">{this.props.songInfo.artist}</div>
                                        <div className="listPlayerSongTitle">{this.props.songInfo.title}</div>
                                    </div>
                                </div>
                            </div>
