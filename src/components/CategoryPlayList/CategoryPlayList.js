      ...
      <div className="categoryPlayList">
        <div className="tabContainer">
          <ul className="tabBody">
            <li
              className={this.props.category === "hiphop" ? "selected" : ""}
              onClick={this.clickTab.bind(this)}
            >
              HipHop
            </li>
            <li
              className={this.props.category === "rnb" ? "selected" : ""}
              onClick={this.clickTab.bind(this)}
            >
              RnB
            </li>
            <li
              className={this.props.category === "soul" ? "selected" : ""}
              onClick={this.clickTab.bind(this)}
            >
              Soul
            </li>
            <li
              className={this.props.category === "kpop" ? "selected" : ""}
              onClick={this.clickTab.bind(this)}
            >
              Kpop
            </li>
            <li
              className={this.props.category === "fork" ? "selected" : ""}
              onClick={this.clickTab.bind(this)}
            >
              Fork
            </li>
            <li
              className={this.props.category === "ballad" ? "selected" : ""}
              onClick={this.clickTab.bind(this)}
            >
              Ballad
            </li>
            <li
              className={this.props.category === "edm" ? "selected" : ""}
              onClick={this.clickTab.bind(this)}
            >
              EDM
            </li>
            <li
              className={this.props.category === "etc" ? "selected" : ""}
              onClick={this.clickTab.bind(this)}
            >
              Etc
            </li>
