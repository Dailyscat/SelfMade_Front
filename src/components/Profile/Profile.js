                        ...
                        <div className = "profileBody">
                            <div className = "profileBodyContainer">
                                <ul className = "tabBody" >
                                    <li className = {this.state.selected === "Customer" ?"selected" : ""} onClick = {this.clickTab.bind(this)}>Customer</li>
                                    <li className = {this.state.selected === "Artist" ?"selected" : ""} onClick = {this.clickTab.bind(this)}>Artist</li>
                                </ul>
                                <hr/>
